            ...
            <div style="display:flex;flex-direction:column;gap:45px;">
                <div style="display:flex;flex-direction:column;gap:24px;">
                    ...
                    <p style="line-height:150%;margin:0;padding:0;">Thanks for joining Movie quotes! We really
                        appreciate it. Please click the button below to verify your account:</p>
                    <a href="{{ $url }}"
                        style="color:#ffffff;text-decoration:none;background-color:#E31221;max-width:max-content;border-radius:5px;margin:0;padding:7px 15px;">Verify
                        account</a>
                </div>
                <div style="display:flex;flex-direction:column;gap:24px;">
